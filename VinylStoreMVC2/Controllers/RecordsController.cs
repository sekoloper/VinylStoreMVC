...
namespace VinylStoreMVC.Controllers
{
    ...
    /// Предоставляет полный набор CRUD-операций для сущности Record с поддержкой связей исполнителями, жанрами и статусами.
    /// </summary>
    public class RecordsController : Controller
    {
        ...
        /// </summary>
        /// <returns>Представление со списком всех пластинок, включая информацию об исполнителе, статусах и жанрах.</returns>
        // GET: Records
        ...
        /// <returns>
        /// Представление с детальной информацией о пластинке, включая связанные данные об исполнителе, статусе и жанрах.
        ...
        /// Подготавливает списки исполнителей и жанров для выбора в форме.
        /// </summary>
