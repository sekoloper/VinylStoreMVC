...
namespace VinylStoreMVC.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        /// </summary>
        /// <returns>Представление со списком всех продаж, включая информацию о пластинках и их артистах.</returns>
        // GET: Sales
        ...
        /// <returns>
        /// Представление с детальной информацией о продаже, включая связанные пластинки и артистов.
