...
namespace VinylStoreMVC.Controllers
{
    ...
    public class ShipmentsController : Controller
    {
        ...
        /// </summary>
        /// <returns>Представление со списком всех поставок, включая информацию о поставщиках, пластинках и их исполнителей.</returns>
        // GET: Shipments
        ...
        /// <returns>
        /// Представление с детальной информацией о поставке, включая связанных поставщиков, пластинки и исполнителей..
